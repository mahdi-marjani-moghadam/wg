                ...
                <div class="col-xs-12 col-sm-12 col-md-8  center-block">
                    ...
                    <textarea name="description" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 pull-right">
                                        ...
                                        <select name="category[]" data-input="select2" placeholder="دسته بندی مورد نظر را انتخاب کنید." multiple>
                                            <?
                                            foreach($list['categoryList'] as $category_id => $value)
                                            {
                                                ?>
                                    ...
                                    <div class="col-sm-5">
                                        <div data-intro="" data-provides="fileinput" class="fileinput fileinput-new">
                                            <span class="btn btn-icon btn-icon-right btn-warning btn-file">
                                                ...
                                                <input type="file" id="ax" name="originPic" value="<?=$list['originPic']?>">
                                            </span>
                            ...
                            <ul>
                                ...
                                <li  style="list-style-type:none">
                                    <div class="col-xs-12 col-sm-12 col-md-6 pull-right">
                                        ...
                                        <div class="form-group">
                                            <?php //$i=1;?>
                                            <label class="col-xs-12 col-sm-4 control-label rtl pull-right" for="text1">عکس <?=$i+1;?>:</label>
                                            <div class="col-sm-5">
                                                <div data-intro="" data-provides="fileinput" class="fileinput fileinput-new">
                                                    <span class="btn btn-icon btn-icon-right btn-warning btn-file">
                                                        <i class="fa fa-upload"></i>
                                                        <span class="fileinput-new">انتخاب</span>
                                                        <span class="fileinput-exists">تغییر</span>
                                                        <input type="file" id="ax" name="otherPic[]" value="<?=$list['otherPic'][$i];?>">
                                                    </span>
                                                    <span class="fileinput-filename"></span>
                                                    <button style="float: none" data-dismiss="fileinput"
                                                            class="close fileinput-exists">×
                        ...
                        <div class="row">
                            ...
                            <input name="Portfolio_id" type="hidden" id="action" value="<?=$list['Portfolio_id']?>" />
                            <div class="col-md-12">
                                <p class="pull-right">
