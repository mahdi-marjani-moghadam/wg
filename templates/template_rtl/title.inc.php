...
<head>
    ...
    <link rel="stylesheet" href="<?=TEMPLATE_DIR?>css/fonts.css" type="text/css" />
...
<body class="stretched rtl no-transition">
            ...
            <div class="container clearfix">
                ...
                <nav id="primary-menu">
                    ...
                    <ul class="one-page-menu" data-easing="easeInOutExpo" data-speed="1250" data-offset="65">
                        <li><a href="<?=RELA_DIR?>" ><div>خانه</div></a></li>
                        <li><a href="<?=RELA_DIR?>aboutus" ><div>درباره ما</div></a></li>
                        <li><a href="<?=RELA_DIR?>portfolio" ><div>نمونه کار</div></a></li>
                        <li><a href="<?=RELA_DIR?>portfolio" ><div>خدمات</div></a></li>
                        <li><a href="<?=RELA_DIR?>education"><div>آموزش</div></a></li>
                        <li><a href="<?=RELA_DIR?>contactus" ><div>تماس با ما</div></a></li>
                    </ul>
